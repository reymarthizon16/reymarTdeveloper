		...
		<tr>			
			...
			?>
					<td>
						...
						<span style="font-weight:normal"><?php echo $data[$specimenid]['release_date']." ".$data[$specimenid]['release_time']?></span>
					</td>
			<?php 
				}
				
				if(count($specimenids) != 5)
				{
					for($filler = 5 - count($specimenids); $filler!=0;$filler--)
