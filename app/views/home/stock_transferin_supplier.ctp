<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">  Stock Transfer In (from supplier)</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="col-lg-12">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="list-group" style="overflow: auto;height: 53vh;">
                                        ...
                                        <a href="#" class="list-group-item">
                                            ...
                                            <span class="pull-right text-muted small"><em>Standard Fan </em>
                                            </span>
                                        </a>

                                        <a href="#" class="list-group-item">
                                            <i class=" fa-fw">Ref</i> <strong>Samsung</strong>
                                            <span class="pull-right text-muted small"><em>Refrigerator Samsung 2 doors</em>
                                            </span>
                                        </a>

                                        <a href="#" class="list-group-item">
                                            <i class=" fa-fw">Aircon</i> <strong>LG</strong>
                                            <span class="pull-right text-muted small"><em>LG aircon with super fan </em>
                                            </span>
                                        </a>

                                        <a href="#" class="list-group-item">
                                            <i class=" fa-fw">Tv</i> <strong>Samsung</strong>
                                            <span class="pull-right text-muted small"><em>42 inches Samsung TV </em>
                                            </span>
                                        </a>

                                        <a href="#" class="list-group-item">
                                            <i class=" fa-fw">Speaker</i> <strong>Dr Dre</strong>
                                            <span class="pull-right text-muted small"><em>Dr Dre Speaker</em>
                                            </span>
                                        </a>
                                                ...
                                                <table class="table table-striped" >
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Fan</td>
                                                            <td>
                                                                <input class="form-control" placeholder="Enter Serial No">
                                                            </td>
                                                            <td>
                                                                <input class="form-control" placeholder="SRP" style="width: 10vh;">
                                                            </td>
                                                            <td>
                                                                <input class="form-control" placeholder="NET" style="width: 10vh;">
                                                            </td>
                                                            <td>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-8"> 
                                        <div class="form-group input-group col-lg-3" style="float: left;margin-right: 20px;">
                                            <span class="input-group-addon"><i class="">DR#</i>
                                            </span>
                                            <input type="text" class="form-control" placeholder="">
                                        </div>
                                        <div class="form-group input-group col-lg-3" style="float: left;margin-right: 20px;">
                                        ...
                                        <div class="form-group input-group col-lg-3" >
                                            <span class="input-group-addon"><i class=""># of Terms</i>
                                            </span>
                                            <input type="text" class="form-control" placeholder="">
                                        </div>
