                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        ...
                                                        <strong>Address : </strong>                                                        
                                                            <span>Cabanatuan</span> 
                                                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                        <strong>Contact No. : </strong>                                                        
                                                            <span>1121-1212-121</span> 
                                                                ...
                                                                <div class="panel-heading">
                                                                    <h4 class="panel-title">
                                                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> 
                                                                            <?php echo $this->element('/account_supplier_profile/supplierTransactionHeader'); ?>                                                                            
                                                                        </a>
                                                                    </h4>
                                                                </div>
                                                                            ...
                                                                            <div class="panel-body">
                                                                                ...
                                                                                <div class="tab-content">
                                                                                    <div class="tab-pane fade active in" id="itemTransaction" style="margin-bottom: 20px;">
                                                                                        <?php echo $this->element('/account_supplier_profile/supplierTransactionBody'); ?>
                                                                                    </div>
                                                                                    <!-- <div class="tab-pane fade" id="itemHistory" style="margin-bottom: 20px;">
                                                                                        <?php //echo $this->element('/account_supplier_profile/supplierItemHistory'); ?>
                                                                                    </div> -->
                                                                                </div>
                                                                            </div>
                                                                            <!-- /.panel-body -->
